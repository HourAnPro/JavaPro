...
<div region="center" style="padding: 1px;">
	<img src="oaLeavebillFormController.do?traceImage&processInstanceId=${processInstanceId}&isIframe">
</div>
<div data-options="region:'south',split:true" style="height:180px;">
	...
	<script type="text/javascript">
		...
		$('#taskHistoryList').datagrid({
	        ...
	        fitColumns:true,
	        showFooter:true,
	        url:'oaLeavebillFormController.do?taskHistoryList&processInstanceId=${processInstanceId}',  
