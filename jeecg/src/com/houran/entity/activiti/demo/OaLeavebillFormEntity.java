package com.houran.entity.activiti.demo;
 ...
 */
@Entity
@Table(name = "oa_leavebill_form", schema = "")
@SuppressWarnings("serial")
public class OaLeavebillFormEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.Integer state;//0初始录入 1 待处理 2 处理成功 3 处理返回
	/**流程实例id*/
