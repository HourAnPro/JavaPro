...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="oaLeavebillFormController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <input id="reason" name="reason" type="text" maxlength="500" style="width: 150px" class="inputxt"  ignore="ignore"  value='${oaLeavebillFormPage.reason}'/>
							<span class="Validform_checktip"></span>
