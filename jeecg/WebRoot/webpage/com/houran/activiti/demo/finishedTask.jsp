...
<script type="text/javascript">
		...
		function viewHistory(processInstanceId){
			var url = "";
			var title = "流程历史";
			url = "oaLeavebillFormController.do?viewProcessInstanceHistory&processInstanceId="+processInstanceId+"&isIframe"
			addOneTab(title, url);
		}
	    // 编辑初始化数据
		...
		$('#finishedTask').datagrid({
	        ...
	        fitColumns:true,
	        showFooter:true,
	        url:'oaLeavebillFormController.do?finishedTaskDataGrid',  
